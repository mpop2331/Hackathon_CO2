...
module.exports = (req, res, next) => {
  ...
  // REVISIT: Once we don't display the error message location in terms of an offset, but instead a copy of the original request including a marker, we don't need to provide the baseUrl here.
